...
INSERT INTO `tcc`.`usuario` (`nome`, `email`, `senha`, `tipo`, `cpf`, `telefone`, `status`) VALUES ('Guilherme', 'gui@gmail.com', '123eq123', 'analista', '123-456-789-10', '(01) 23456-7891', 'ativado');
INSERT INTO `tcc`.`usuario` (`nome`, `email`, `senha`, `tipo`, `cpf`, `telefone`, `status`) VALUES ('Vinicius', 'vini@gmail.com', '123eq123', 'programador', '123-456-789-10', '(01) 23456-7891', 'ativado');
